...
func TestSzEngine_ExportCsvEntityReport_badCsvColumnList(test *testing.T) {
	...
	expectedErr := `{"function":"szengine.(*Szengine).ExportCsvEntityReport","error":{"function":"szengineserver.(*SzEngineServer).ExportCsvEntityReport","error":{"function":"szengine.(*Szengine).ExportCsvEntityReport","error":{"id":"SZSDK60044007","reason":"SENZ3131|Invalid column [BAD] requested for CSV export."}}}}`
...
func TestSzEngine_ExportCsvEntityReportIterator_badCsvColumnList(test *testing.T) {
	...
	for actual := range szEngine.ExportCsvEntityReportIterator(ctx, badCsvColumnList, flags) {
		...
		expectedErr := `{"function":"szengineserver.(*SzEngineServer).StreamExportCsvEntityReport","text":"ExportCsvEntityReport","error":{"function":"szengine.(*Szengine).ExportCsvEntityReport","error":{"id":"SZSDK60044007","reason":"SENZ3131|Invalid column [BAD] requested for CSV export."}}}`
...
func TestSzEngine_FetchNext_badExportHandle(test *testing.T) {
	...
	expectedErr := `{"function":"szengine.(*Szengine).FetchNext","error":{"function":"szengineserver.(*SzEngineServer).FetchNext","error":{"function":"szengine.(*Szengine).FetchNext","error":{"id":"SZSDK60044009","reason":"SENZ3103|Invalid Export Handle [0]"}}}}`
	require.JSONEq(test, expectedErr, err.Error())
}
...
func getEntityIDStringForRecord(ctx context.Context, datasource string, recordID string) string { //nolint
	var result string

	entityID := getEntityIDForRecord(ctx, datasource, recordID)
	...
	result := []TestMetadataForAddRecord{
		{
			...
			expectedErrMessage: `{"function":"szengine.(*Szengine).AddRecord","error":{"function":"szengineserver.(*SzEngineServer).AddRecord","error":{"function":"szengine.(*Szengine).AddRecord","error":{"id":"SZSDK60044001","reason":"SENZ0023|Conflicting DATA_SOURCE values 'BADDATASOURCECODE' and 'CUSTOMERS'"}}}}`,
		},
		{
		...
		},
		{
			...
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).AddRecord","error":{"function":"szengineserver.(*SzEngineServer).AddRecord","error":{"function":"szengine.(*Szengine).AddRecord","error":{"id":"SZSDK60044001","reason":"SENZ0023|Conflicting DATA_SOURCE values 'CUSTOMERS' and 'BOB'"}}}}`,
		...
		},
		{
			...
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).AddRecord","error":{"function":"szengineserver.(*SzEngineServer).AddRecord","error":{"function":"szengine.(*Szengine).AddRecord","error":{"id":"SZSDK60044001","reason":"SENZ3121|JSON Parsing Failure [code=3,offset=0]"}}}}`,
		},
		{
			name:               "badRecordID",
			recordID:           badRecordID,
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).AddRecord","error":{"function":"szengineserver.(*SzEngineServer).AddRecord","error":{"function":"szengine.(*Szengine).AddRecord","error":{"id":"SZSDK60044001","reason":"SENZ0024|Conflicting RECORD_ID values 'BadRecordID' and '1001'"}}}}`,
		},
		{
			name: "default",
		},
		{
			...
			// expectedErrMessage: `{"function":"szengine.(*Szengine).DeleteRecord","error":{"function":"szengineserver.(*SzEngineServer).DeleteRecord","error":{"function":"szengine.(*Szengine).DeleteRecord","error":{"id":"SZSDK60044004","reason":"SENZ2136|Error in input mapping, missing required field[DATA_SOURCE]"}}}}`,
		},
		{
			name:               "nilRecordDefinition",
			recordDefinition:   nilRecordDefinition,
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).AddRecord","error":{"function":"szengineserver.(*SzEngineServer).AddRecord","error":{"function":"szengine.(*Szengine).AddRecord","error":{"id":"SZSDK60044001","reason":"SENZ3121|JSON Parsing Failure [code=1,offset=0]"}}}}`,
		},
		{
			name:     "nilRecordID",
		...
		},
		{
			...
			flags:              senzing.SzWithInfo,
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).AddRecord","error":{"function":"szengineserver.(*SzEngineServer).AddRecord","error":{"function":"szengine.(*Szengine).AddRecord","error":{"id":"SZSDK60044002","reason":"SENZ0023|Conflicting DATA_SOURCE values 'BADDATASOURCECODE' and 'CUSTOMERS'"}}}}`,
		},
		{
			...
			recordDefinition:   badRecordDefinition,
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).AddRecord","error":{"function":"szengineserver.(*SzEngineServer).AddRecord","error":{"function":"szengine.(*Szengine).AddRecord","error":{"id":"SZSDK60044002","reason":"SENZ3121|JSON Parsing Failure [code=3,offset=0]"}}}}`,
		},
		{
			...
			recordID:           badRecordID,
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).AddRecord","error":{"function":"szengineserver.(*SzEngineServer).AddRecord","error":{"function":"szengine.(*Szengine).AddRecord","error":{"id":"SZSDK60044002","reason":"SENZ0024|Conflicting RECORD_ID values 'BadRecordID' and '1001'"}}}}`,
		},
		{
		...
		},
		{
			...
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).AddRecord","error":{"function":"szengineserver.(*SzEngineServer).AddRecord","error":{"function":"szengine.(*Szengine).AddRecord","error":{"id":"SZSDK60044002","reason":"SENZ3121|JSON Parsing Failure [code=1,offset=0]"}}}}`,
			flags:              senzing.SzWithInfo,
			recordDefinition:   nilRecordDefinition,
		},
		{
	...
	result := []TestMetadataForDeleteRecord{
		{
			...
			expectedErrMessage: `{"function":"szengine.(*Szengine).DeleteRecord","error":{"function":"szengineserver.(*SzEngineServer).DeleteRecord","error":{"function":"szengine.(*Szengine).DeleteRecord","error":{"id":"SZSDK60044004","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
		},
		{
		...
		},
		{
			...
			expectedErrMessage: `{"function":"szengine.(*Szengine).DeleteRecord","error":{"function":"szengineserver.(*SzEngineServer).DeleteRecord","error":{"function":"szengine.(*Szengine).DeleteRecord","error":{"id":"SZSDK60044004","reason":"SENZ0053|RECORD_ID must be provided"}}}}`,
			recordID:           nilRecordID,
		},
		{
			name:  "withInfo",
		...
		},
		{
			...
			dataSourceCode:     badDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).DeleteRecord","error":{"function":"szengineserver.(*SzEngineServer).DeleteRecord","error":{"function":"szengine.(*Szengine).DeleteRecord","error":{"id":"SZSDK60044005","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
		},
		{
			name:     "withInfo_badRecordID",
			flags:    senzing.SzWithInfo,
		...
		},
		{
			...
			dataSourceCode:     nilDataSourceCode,
			expectedErr:        szerror.ErrSzConfiguration,
			expectedErrMessage: `{"function":"szengine.(*Szengine).DeleteRecord","error":{"function":"szengineserver.(*SzEngineServer).DeleteRecord","error":{"function":"szengine.(*Szengine).DeleteRecord","error":{"id":"SZSDK60044005","reason":"SENZ2136|Error in input mapping, missing required field[DATA_SOURCE]"}}}}`,
		},
		{
			name:               "withInfo_nilRecordID",
			expectedErr:        szerror.ErrSzNotInitialized,
			expectedErrMessage: `{"function":"szengine.(*Szengine).DeleteRecord","error":{"function":"szengineserver.(*SzEngineServer).DeleteRecord","error":{"function":"szengine.(*Szengine).DeleteRecord","error":{"id":"SZSDK60044005","reason":"SENZ0053|RECORD_ID must be provided"}}}}`,
			flags:              senzing.SzWithInfo,
			recordID:           nilRecordID,
		},
	}
	...
	result := []TestMetadataForFindInterestingEntitiesByEntityID{
		{
			...
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindInterestingEntitiesByEntityID","error":{"function":"szengineserver.(*SzEngineServer).FindInterestingEntitiesByEntityId","error":{"function":"szengine.(*Szengine).FindInterestingEntitiesByEntityID","error":{"id":"SZSDK60044010","reason":"SENZ0037|Unknown resolved entity value '-1'"}}}}`,
		},
		{
			name: "default",
		},
		{
			...
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindInterestingEntitiesByEntityID","error":{"function":"szengineserver.(*SzEngineServer).FindInterestingEntitiesByEntityId","error":{"function":"szengine.(*Szengine).FindInterestingEntitiesByEntityID","error":{"id":"SZSDK60044010","reason":"SENZ0037|Unknown resolved entity value '0'"}}}}`,
		},
	}
	...
	result := []TestMetadataForFindInterestingEntitiesByRecordID{
		{
			...
			dataSourceCode:     badDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindInterestingEntitiesByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindInterestingEntitiesByRecordId","error":{"function":"szengine.(*Szengine).FindInterestingEntitiesByRecordID","error":{"id":"SZSDK60044011","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
		},
		{
			name:               "badRecordID",
			recordID:           badRecordID,
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindInterestingEntitiesByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindInterestingEntitiesByRecordId","error":{"function":"szengine.(*Szengine).FindInterestingEntitiesByRecordID","error":{"id":"SZSDK60044011","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[BadRecordID]"}}}}`,
		},
		{
			name: "default",
		},
		{
			...
			dataSourceCode:     nilDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindInterestingEntitiesByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindInterestingEntitiesByRecordId","error":{"function":"szengine.(*Szengine).FindInterestingEntitiesByRecordID","error":{"id":"SZSDK60044011","reason":"SENZ2207|Data source code [] does not exist."}}}}`,
		},
		{
			name:               "nilRecordID",
			recordID:           nilRecordID,
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindInterestingEntitiesByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindInterestingEntitiesByRecordId","error":{"function":"szengine.(*Szengine).FindInterestingEntitiesByRecordID","error":{"id":"SZSDK60044011","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[]"}}}}`,
		},
	}
	...
	result := []TestMetadataForFindNetworkByEntityID{
		{
			...
			expectedErr:        szerror.ErrSz,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindNetworkByEntityID","error":{"function":"szengineserver.(*SzEngineServer).FindNetworkByEntityId","error":{"function":"szengine.(*Szengine).FindNetworkByEntityID","error":{"id":"SZSDK60044013","reason":"SENZ0032|Invalid value of build out degree '-1'"}}}}`,
		},
		{
			name:                "badBuildOutMaxEntities",
			buildOutMaxEntities: badBuildOutMaxEntities,
			expectedErr:         szerror.ErrSz,
			expectedErrMessage:  `{"function":"szengine.(*Szengine).FindNetworkByEntityID","error":{"function":"szengineserver.(*SzEngineServer).FindNetworkByEntityId","error":{"function":"szengine.(*Szengine).FindNetworkByEntityID","error":{"id":"SZSDK60044013","reason":"SENZ0029|Invalid value of max entities '-1'"}}}}`,
		},
		{
			name:      "badEntityIDs",
		...
		},
		{
			...
			expectedErr:        szerror.ErrSz,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindNetworkByEntityID","error":{"function":"szengineserver.(*SzEngineServer).FindNetworkByEntityId","error":{"function":"szengine.(*Szengine).FindNetworkByEntityID","error":{"id":"SZSDK60044013","reason":"SENZ0031|Invalid value of max degree '-1'"}}}}`,
		},
		{
			name: "default",
		},
	...
	result := []TestMetadataForFindNetworkByRecordID{
		{
			...
			buildOutDegrees:    badBuildOutDegrees,
			expectedErr:        szerror.ErrSz,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindNetworkByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindNetworkByRecordId","error":{"function":"szengine.(*Szengine).FindNetworkByRecordID","error":{"id":"SZSDK60044015","reason":"SENZ0032|Invalid value of build out degree '-1'"}}}}`,
		},
		{
			name:               "badBuildOutMaxEntities",
		...
		},
		{
			name:               "badDataSourceCode",
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindNetworkByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindNetworkByRecordId","error":{"function":"szengine.(*Szengine).FindNetworkByRecordID","error":{"id":"SZSDK60044015","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
			recordKeys:         recordKeysBadDataSourceCodeFunc,
		},
		{
			name:               "badMaxDegree",
			expectedErr:        szerror.ErrSz,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindNetworkByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindNetworkByRecordId","error":{"function":"szengine.(*Szengine).FindNetworkByRecordID","error":{"id":"SZSDK60044015","reason":"SENZ0031|Invalid value of max degree '-1'"}}}}`,
			maxDegrees:         badMaxDegrees,
		},
		{
			name:               "badRecordID",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindNetworkByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindNetworkByRecordId","error":{"function":"szengine.(*Szengine).FindNetworkByRecordID","error":{"id":"SZSDK60044015","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[BadRecordID]"}}}}`,
...
func getTestCasesForFindPathByEntityID() []TestMetadataForFindPathByEntityID {
	result := []TestMetadataForFindPathByEntityID{
		...
		},
		{
			...
			avoidEntityIDs:     avoidEntityIDsFunc,
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByEntityId","error":{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"id":"SZSDK60044021","reason":"SENZ0037|Unknown resolved entity value '-1'"}}}}`,
		...
		},
		{
			...
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByEntityId","error":{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"id":"SZSDK60044021","reason":"SENZ3121|JSON Parsing Failure [code=3,offset=0]"}}}}`,
		},
		{
			name:               "badEndEntityID",
			endEntityID:        badEntityID,
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByEntityId","error":{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"id":"SZSDK60044017","reason":"SENZ0037|Unknown resolved entity value '-1'"}}}}`,
		},
		{
			name:               "badMaxDegrees",
			expectedErr:        szerror.ErrSz,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByEntityId","error":{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"id":"SZSDK60044017","reason":"SENZ0031|Invalid value of max degree '-1'"}}}}`,
			maxDegrees:         badMaxDegrees,
		},
		{
			name:                "badRequiredDataSource",
			expectedErr:         szerror.ErrSzBadInput,
			expectedErrMessage:  `{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByEntityId","error":{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"id":"SZSDK60044025","reason":"SENZ3121|JSON Parsing Failure [code=3,offset=0]"}}}}`,
		...
		},
		{
			...
			expectedErr:         szerror.ErrSzNotFound,
			expectedErrMessage:  `{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByEntityId","error":{"function":"szengine.(*Szengine).FindPathByEntityID","error":{"id":"SZSDK60044025","reason":"SENZ0037|Unknown resolved entity value '-1'"}}}}`,
			requiredDataSources: requiredDataSourcesFunc,
			startEntityID:       badEntityID,
		},
		{
...
func getTestCasesForFindPathByRecordID() []TestMetadataForFindPathByRecordID {
	result := []TestMetadataForFindPathByRecordID{
		...
		},
		{
			...
			avoidRecordKeys:     avoidRecordIDsFunc,
			expectedErr:         szerror.ErrSzUnknownDataSource,
			expectedErrMessage:  `{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByRecordId","error":{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"id":"SZSDK60044023","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
		...
		},
		{
			...
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByRecordId","error":{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"id":"SZSDK60044023","reason":"SENZ3121|JSON Parsing Failure [code=3,offset=0]"}}}}`,
		},
		{
			name:               "badDataRecordID",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByRecordId","error":{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"id":"SZSDK60044019","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[BadRecordID]"}}}}`,
			startRecordID:      badRecordID,
		},
		{
			name:                "badDataSourceCode",
			expectedErr:         szerror.ErrSzUnknownDataSource,
			expectedErrMessage:  `{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByRecordId","error":{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"id":"SZSDK60044019","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
			startDataSourceCode: badDataSourceCode,
		},
		{
			name:               "badMaxDegrees",
			expectedErr:        szerror.ErrSz,
			expectedErrMessage: `{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByRecordId","error":{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"id":"SZSDK60044019","reason":"SENZ0031|Invalid value of max degree '-1'"}}}}`,
			maxDegrees:         badMaxDegrees,
		},
		{
		...
		},
		{
			...
			expectedErr:         szerror.ErrSzUnknownDataSource,
			expectedErrMessage:  `{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByRecordId","error":{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"id":"SZSDK60044027","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
			requiredDataSources: requiredDataSourcesFunc,
			startDataSourceCode: badDataSourceCode,
		},
		{
			name:                "nilDataSourceCode",
			expectedErr:         szerror.ErrSzUnknownDataSource,
			expectedErrMessage:  `{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"function":"szengineserver.(*SzEngineServer).FindPathByRecordId","error":{"function":"szengine.(*Szengine).FindPathByRecordID","error":{"id":"SZSDK60044019","reason":"SENZ2207|Data source code [] does not exist."}}}}`,
	...
	result := []TestMetadataForGetEntityByEntityID{
		{
			...
			entityID:           badEntityID,
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetEntityByEntityID","error":{"function":"szengineserver.(*SzEngineServer).GetEntityByEntityId","error":{"function":"szengine.(*Szengine).GetEntityByEntityID","error":{"id":"SZSDK60044030","reason":"SENZ0037|Unknown resolved entity value '-1'"}}}}`,
		},
		{
			name: "default",
		},
		{
			...
			entityID:           nilEntityID,
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetEntityByEntityID","error":{"function":"szengineserver.(*SzEngineServer).GetEntityByEntityId","error":{"function":"szengine.(*Szengine).GetEntityByEntityID","error":{"id":"SZSDK60044030","reason":"SENZ0037|Unknown resolved entity value '0'"}}}}`,
		},
	}
	...
	result := []TestMetadataForGetEntityByRecordID{
		{
			...
			dataSourceCode:     badDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetEntityByRecordID","error":{"function":"szengineserver.(*SzEngineServer).GetEntityByRecordId","error":{"function":"szengine.(*Szengine).GetEntityByRecordID","error":{"id":"SZSDK60044032","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
		},
		{
			name:               "badRecordID",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetEntityByRecordID","error":{"function":"szengineserver.(*SzEngineServer).GetEntityByRecordId","error":{"function":"szengine.(*Szengine).GetEntityByRecordID","error":{"id":"SZSDK60044032","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[BadRecordID]"}}}}`,
			recordID:           badRecordID,
		},
		{
			name: "default",
		},
		{
			...
			dataSourceCode:     nilDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetEntityByRecordID","error":{"function":"szengineserver.(*SzEngineServer).GetEntityByRecordId","error":{"function":"szengine.(*Szengine).GetEntityByRecordID","error":{"id":"SZSDK60044032","reason":"SENZ2207|Data source code [] does not exist."}}}}`,
		},
		{
			name:               "nilRecordID",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetEntityByRecordID","error":{"function":"szengineserver.(*SzEngineServer).GetEntityByRecordId","error":{"function":"szengine.(*Szengine).GetEntityByRecordID","error":{"id":"SZSDK60044032","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[]"}}}}`,
			recordID:           nilRecordID,
		},
	}
	...
	result := []TestMetadataForGetRecord{
		{
			...
			dataSourceCode:     badDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetRecord","error":{"function":"szengineserver.(*SzEngineServer).GetRecord","error":{"function":"szengine.(*Szengine).GetRecord","error":{"id":"SZSDK60044035","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
		},
		{
			name:               "badRecordID",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetRecord","error":{"function":"szengineserver.(*SzEngineServer).GetRecord","error":{"function":"szengine.(*Szengine).GetRecord","error":{"id":"SZSDK60044035","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[BadRecordID]"}}}}`,
			recordID:           badRecordID,
		},
		{
			name: "default",
		},
		{
			...
			dataSourceCode:     nilDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetRecord","error":{"function":"szengineserver.(*SzEngineServer).GetRecord","error":{"function":"szengine.(*Szengine).GetRecord","error":{"id":"SZSDK60044035","reason":"SENZ2207|Data source code [] does not exist."}}}}`,
		},
		{
			name:               "nilRecordID",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetRecord","error":{"function":"szengineserver.(*SzEngineServer).GetRecord","error":{"function":"szengine.(*Szengine).GetRecord","error":{"id":"SZSDK60044035","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[]"}}}}`,
			recordID:           nilRecordID,
		},
	}
	...
	result := []TestMetadataForGetVirtualEntityByRecordID{
		{
			name:               "badDataSourceCode",
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetVirtualEntityByRecordID","error":{"function":"szengineserver.(*SzEngineServer).GetVirtualEntityByRecordId","error":{"function":"szengine.(*Szengine).GetVirtualEntityByRecordID","error":{"id":"SZSDK60044038","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
			recordKeys:         badDataSourcesFunc,
		},
		{
			name:               "badRecordID",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).GetVirtualEntityByRecordID","error":{"function":"szengineserver.(*SzEngineServer).GetVirtualEntityByRecordId","error":{"function":"szengine.(*Szengine).GetVirtualEntityByRecordID","error":{"id":"SZSDK60044038","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[BadRecordID]"}}}}`,
	...
	result := []TestMetadataForHowEntityByEntityID{
		{
			...
			entityID:           badEntityID,
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).HowEntityByEntityID","error":{"function":"szengineserver.(*SzEngineServer).HowEntityByEntityId","error":{"function":"szengine.(*Szengine).HowEntityByEntityID","error":{"id":"SZSDK60044040","reason":"SENZ0037|Unknown resolved entity value '-1'"}}}}`,
		},
		{
			name: "default",
		},
		{
			...
			entityID:           nilEntityID,
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).HowEntityByEntityID","error":{"function":"szengineserver.(*SzEngineServer).HowEntityByEntityId","error":{"function":"szengine.(*Szengine).HowEntityByEntityID","error":{"id":"SZSDK60044040","reason":"SENZ0037|Unknown resolved entity value '0'"}}}}`,
		},
	}
	...
	result := []TestMetadataForReevaluateRecord{
		{
			name:               "badDataSourceCode",
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"function":"szengineserver.(*SzEngineServer).ReevaluateRecord","error":{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"id":"SZSDK60044048","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
			dataSourceCode:     badDataSourceCode,
		},
		{
			name:     "badRecordID",
		...
		},
		{
			...
			dataSourceCode:     nilDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"function":"szengineserver.(*SzEngineServer).ReevaluateRecord","error":{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"id":"SZSDK60044048","reason":"SENZ2207|Data source code [] does not exist."}}}}`,
		},
		{
			name:               "nilRecordID",
			expectedErr:        szerror.ErrSzNotInitialized,
			expectedErrMessage: `{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"function":"szengineserver.(*SzEngineServer).ReevaluateRecord","error":{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"id":"SZSDK60044048","reason":"SENZ0053|RECORD_ID must be provided"}}}}`,
			recordID:           nilRecordID,
		},
		{
			name:  "withInfo",
		...
		},
		{
			...
			dataSourceCode:     badDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"function":"szengineserver.(*SzEngineServer).ReevaluateRecord","error":{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"id":"SZSDK60044049","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
			flags:              senzing.SzWithInfo,
		},
		{
			name:     "withInfo_badRecordID",
		...
		},
		{
			...
			dataSourceCode:     nilDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"function":"szengineserver.(*SzEngineServer).ReevaluateRecord","error":{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"id":"SZSDK60044049","reason":"SENZ2207|Data source code [] does not exist."}}}}`,
			flags:              senzing.SzWithInfo,
		},
		{
			name:               "withInfo_nilRecordID",
			expectedErr:        szerror.ErrSzNotInitialized,
			expectedErrMessage: `{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"function":"szengineserver.(*SzEngineServer).ReevaluateRecord","error":{"function":"szengine.(*Szengine).ReevaluateRecord","error":{"id":"SZSDK60044049","reason":"SENZ0053|RECORD_ID must be provided"}}}}`,
			flags:              senzing.SzWithInfo,
			recordID:           nilRecordID,
		},
	}
	...
	result := []TestMetadataForSearchByAttributes{
		{
			...
			expectedErr:        szerror.ErrSz,
			expectedErrMessage: `{"function":"szengine.(*Szengine).SearchByAttributes","error":{"function":"szengineserver.(*SzEngineServer).SearchByAttributes","error":{"function":"szengine.(*Szengine).SearchByAttributes","error":{"id":"SZSDK60044053","reason":"SENZ0027|Invalid value for search-attributes"}}}}`,
		},
		{
			name:               "badSearchProfile",
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).SearchByAttributes","error":{"function":"szengineserver.(*SzEngineServer).SearchByAttributes","error":{"function":"szengine.(*Szengine).SearchByAttributes","error":{"id":"SZSDK60044053","reason":"SENZ0088|Unknown search profile value '}{'"}}}}`,
	...
	result := []TestMetadataForWhyEntities{
		{
			...
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhyEntities","error":{"function":"szengineserver.(*SzEngineServer).WhyEntities","error":{"function":"szengine.(*Szengine).WhyEntities","error":{"id":"SZSDK60044056","reason":"SENZ0037|Unknown resolved entity value '-1'"}}}}`,
		},
		{
			name:               "badEnitity2",
		...
		},
		{
			name:               "nilEnitity1",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhyEntities","error":{"function":"szengineserver.(*SzEngineServer).WhyEntities","error":{"function":"szengine.(*Szengine).WhyEntities","error":{"id":"SZSDK60044056","reason":"SENZ0037|Unknown resolved entity value '0'"}}}}`,
	...
	result := []TestMetadataForWhyRecordInEntity{
		{
			...
			dataSourceCode:     badDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhyRecordInEntity","error":{"function":"szengineserver.(*SzEngineServer).WhyRecordInEntity","error":{"function":"szengine.(*Szengine).WhyRecordInEntity","error":{"id":"SZSDK60044058","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
		},
		{
			name:               "badRecordID",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhyRecordInEntity","error":{"function":"szengineserver.(*SzEngineServer).WhyRecordInEntity","error":{"function":"szengine.(*Szengine).WhyRecordInEntity","error":{"id":"SZSDK60044058","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[BadRecordID]"}}}}`,
			recordID:           badRecordID,
		},
		{
			name: "default",
		},
		{
			...
			dataSourceCode:     nilDataSourceCode,
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhyRecordInEntity","error":{"function":"szengineserver.(*SzEngineServer).WhyRecordInEntity","error":{"function":"szengine.(*Szengine).WhyRecordInEntity","error":{"id":"SZSDK60044058","reason":"SENZ2207|Data source code [] does not exist."}}}}`,
		},
		{
			name:               "nilRecordID",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhyRecordInEntity","error":{"function":"szengineserver.(*SzEngineServer).WhyRecordInEntity","error":{"function":"szengine.(*Szengine).WhyRecordInEntity","error":{"id":"SZSDK60044058","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[]"}}}}`,
			recordID:           nilRecordID,
		},
	}
	...
	result := []TestMetadataForWhyRecords{
		{
			...
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhyRecords","error":{"function":"szengineserver.(*SzEngineServer).WhyRecords","error":{"function":"szengine.(*Szengine).WhyRecords","error":{"id":"SZSDK60044060","reason":"SENZ2207|Data source code [BADDATASOURCECODE] does not exist."}}}}`,
		},
		{
		...
		},
		{
			name:               "badRecordID1",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhyRecords","error":{"function":"szengineserver.(*SzEngineServer).WhyRecords","error":{"function":"szengine.(*Szengine).WhyRecords","error":{"id":"SZSDK60044060","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[BadRecordID]"}}}}`,
		...
		},
		{
			...
			expectedErr:        szerror.ErrSzUnknownDataSource,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhyRecords","error":{"function":"szengineserver.(*SzEngineServer).WhyRecords","error":{"function":"szengine.(*Szengine).WhyRecords","error":{"id":"SZSDK60044060","reason":"SENZ2207|Data source code [] does not exist."}}}}`,
		},
		{
		...
		},
		{
			name:               "nilRecordID1",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhyRecords","error":{"function":"szengineserver.(*SzEngineServer).WhyRecords","error":{"function":"szengine.(*Szengine).WhyRecords","error":{"id":"SZSDK60044060","reason":"SENZ0033|Unknown record: dsrc[CUSTOMERS], record[]"}}}}`,
	...
	result := []TestMetadataForWhySearch{
		{
			...
			attributes:         badAttributes,
			expectedErr:        szerror.ErrSz,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhySearch","error":{"function":"szengineserver.(*SzEngineServer).WhySearch","error":{"function":"szengine.(*Szengine).WhySearch","error":{"id":"SZSDK60044064","reason":"SENZ0027|Invalid value for search-attributes"}}}}`,
		},
		{
			name:               "badEntityID",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhySearch","error":{"function":"szengineserver.(*SzEngineServer).WhySearch","error":{"function":"szengine.(*Szengine).WhySearch","error":{"id":"SZSDK60044064","reason":"SENZ0037|Unknown resolved entity value '-1'"}}}}`,
			entityID:           badEntityID,
		},
		{
			name:               "badSearchProfile",
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhySearch","error":{"function":"szengineserver.(*SzEngineServer).WhySearch","error":{"function":"szengine.(*Szengine).WhySearch","error":{"id":"SZSDK60044064","reason":"SENZ0088|Unknown search profile value '}{'"}}}}`,
			searchProfile:      badSearchProfile,
		},
		{
			name: "default",
		...
		},
		{
			name:               "nilEntityID",
			expectedErr:        szerror.ErrSzNotFound,
			expectedErrMessage: `{"function":"szengine.(*Szengine).WhySearch","error":{"function":"szengineserver.(*SzEngineServer).WhySearch","error":{"function":"szengine.(*Szengine).WhySearch","error":{"id":"SZSDK60044064","reason":"SENZ0037|Unknown resolved entity value '0'"}}}}`,
			entityID:           nilEntityID,
		},
		{
			name:          "searchProfile",
...
func avoidEntityIDsFunc() string {
	ctx := context.TODO()
	result := `{"ENTITIES": [{"ENTITY_ID": ` + getEntityIDStringForRecord(ctx, "CUSTOMERS", "1001") + `}]}`
