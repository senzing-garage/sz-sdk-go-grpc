	...
	result := []TestMetadataForPreprocessRecord{
		{
			name:               "badRecordDefinition",
			expectedErr:        szerror.ErrSzBadInput,
			expectedErrMessage: `{"function":"szengine.(*Szengine).PreprocessRecord","error":{"function":"szengineserver.(*SzEngineServer).PreprocessRecord","error":{"function":"szengine.(*Szengine).PreprocessRecord","error":{"id":"SZSDK60044061","reason":"SENZ0002|Invalid Message"}}}}`,
			recordDefinition:   badRecordDefinition,
		},
		{
			name: "default",
